import { Renderer, Triangle, Program, Mesh, Texture } from 'https://esm.sh/ogl';
...
// === MOUNT TO DOM ===
const rootElement = document.getElementById('react-root-memories');
if (rootElement) {
    ...
    root.render(
        <MorphSlider
            ...
            loop
            radius={16}
            showCaptions={false} /* Turned off captions because "Memories 59" might not look great */
            showControls={true}
            showIndicators={false} /* 60 dots is too many */
        />
    );
}
